...
### Sprint 1 — Foundation
- **Modular plugin architecture** — 11 separate modules (player, animation, camera, level, health, hud, state, audio, parallax, enemies, collectibles, hazards)
...
- Re-enable and refine particle effects (jump dust, landing dust)
