...
// Knockback
pub const KNOCKBACK_HORIZONTAL: f32 = 250.0;
pub const KNOCKBACK_VERTICAL: f32 = 200.0;

// Screen shake
pub const SHAKE_DURATION: f32 = 0.25;
pub const SHAKE_INTENSITY_DAMAGE: f32 = 5.0;
pub const SHAKE_INTENSITY_STOMP: f32 = 3.0;

// Slide
pub const SLIDE_DURATION: f32 = 0.4;
pub const SLIDE_SPEED: f32 = 450.0;

// Hurt / Death animation
pub const HURT_DURATION: f32 = 0.3;
pub const DEATH_DURATION: f32 = 0.7;
