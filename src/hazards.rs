...
use crate::player::{Player, PlayerMovementSet, Velocity};
...
fn spike_player_collision(
    ...
    mut player_query: Query<(&Transform, &mut Velocity, Option<&Invincible>), With<Player>>,
    ...
    for spike_tf in &spike_query {
        ...
        if overlap_x > 0.0 && overlap_y > 0.0 {
            ...
            // Knockback: push player straight up
            player_vel.0.y = KNOCKBACK_VERTICAL;
